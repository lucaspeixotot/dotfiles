...
** Backup files
   #+BEGIN_SRC emacs-lisp
     ...
     (setq auto-save-file-name-transforms
       `((".*" "~/.emacs-style.d/backup-save-file" t)))
   #+END_SRC
** Flyspell
   #+BEGIN_SRC emacs-lisp
...
** Key-chord
   #+BEGIN_SRC emacs-lisp
     (use-package key-chord
       ...
       (key-chord-mode 1)
       :config
       (key-chord-define-global "ça"  'avy-goto-char)
       (key-chord-define-global "çl"  'avy-goto-line)       
       (key-chord-define-global "çf"  'iy-go-to-char)       
     )
   #+END_SRC
...
** Imenu
   #+BEGIN_SRC emacs-lisp
     (use-package imenu-anywhere
       :ensure t
       :config
       (global-set-key (kbd "M-o") #'ivy-imenu-anywhere)
       )
   #+END_SRC
