...
#+begin_src emacs-lisp
  (use-package god-mode
    ...
    (define-key god-local-mode-map (kbd "f") #'avy-goto-char-in-line)
    (custom-set-faces
...
#+begin_src emacs-lisp
  (use-package eglot
    ...
    (global-set-key (kbd "C-c e d") #'eglot-shutdown)
...
#+begin_src emacs-lisp
  ...
  (use-package consult-todo :straight t :demand t)
#+end_src
** Save place
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  (use-package exec-path-from-shell
    ...
    (dolist (var '("CONFLUENCE_API_TOKEN" "JIRA_API_TOKEN" "GITHUB_PERSONAL_ACCESS_TOKEN" "JAVA_OPTS" "PATH"))
...
#+begin_src emacs-lisp
  (use-package blame-reveal
    :straight (blame-reveal :type git :host github :repo "LuciusChen/blame-reveal")
